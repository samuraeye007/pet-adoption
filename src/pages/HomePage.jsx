...
export default function HomePage() {
  return (
    <>
      ...
      <PageContainer>
        <TextDiv>
          <h1>Welcome to Miaudote. Our adoption portal for all pets!</h1>

          <p>
            Explore our gallery and <b>find the perfect pet to become part of your family</b>.
          </p>
          <Link to="/pets">
          ...
          <p>
            <b>Register a pet for adoption</b> and help us unite adorable animals with loving families.
          </p>
          <Link to="/new-pet">
